...
var _ tusd.DataStore = LocalStore{}
var _ tusd.GetReaderDataStore = LocalStore{}
var _ tusd.TerminaterDataStore = LocalStore{}
var _ tusd.LockerDataStore = LocalStore{}
var _ tusd.ConcaterDataStore = LocalStore{}

func TestFilestore(t *testing.T) {
	a := assert.New(t)

	tmp, err := ioutil.TempDir(config.App.TempDir, "tusd-localstore-")
	a.NoError(err)
...
func TestMissingPath(t *testing.T) {
	...
	store := LocalStore{"./path-that-does-not-exist"}
...
func TestConcatUploads(t *testing.T) {
	...
	tmp, err := ioutil.TempDir("", "tusd-localstore-concat-")
	a.NoError(err)
